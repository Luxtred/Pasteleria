...
<body>
    ...
    <div class="categories">
            <button class="category-btn active" data-id="0">Todos</button> <!-- 0 para mostrar todos -->
        <?php foreach ($categorias as $categoria): ?>
            <button class="category-btn" data-id="<?= $categoria->idCategoria ?>"><?= $categoria->categoria ?></button>
        <?php endforeach; ?>
    </div>
